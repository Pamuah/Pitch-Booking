...
const MainAdminLoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('https://football-park-management.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div 
          ...
          style={{
            ...
            backgroundImage: 'url("https://images.pexels.com/photos/399187/pexels-photo-399187.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")',
        ...
        <div className="w-full md:w-2/5 bg-white flex flex-col justify-center items-center p-8">
          ...
          >
            ...
            {error && <p className="text-red-500 mb-4 text-sm text-center bg-red-50 p-3 rounded-md">{error}</p>}
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-sm text-green-400 hover:text-green-500 hover:underline transition-colors">
                  Forgot password?
                </a>
              </div>
